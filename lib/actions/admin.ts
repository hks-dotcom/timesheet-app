// Core server-side logic for the Users screen actions.
//
...
// in app/actions/admin.ts, and each one resolves the session itself.
//
...
import { FUNCTION_ACCOUNT } from "../accounts";
import { getPool } from "../db";
import { revalidateAfterCommit } from "../revalidate";
import { latestContractTerm, type ContractTermRow } from "../domain";
