...
import { BATCH_REF_PATTERN, buildHandoff, handoffDetailCsvRows, handoffFilename } from "@/lib/handoff";
import { getReportableForEntity } from "@/lib/repo";
import { getCurrentUser } from "@/lib/session";

// The payroll handoff FILE for one Mark processed batch — offered the
// moment a batch commits, and from the batch list afterwards. Same
// builder and format as Reports' by-run file (lib/handoff.ts), sliced to
// exactly the weeks that batch processed.
//
